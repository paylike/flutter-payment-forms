...
const Map<String, String> sk = {
  ...
  "ERROR_TIMEOUT": "Neočakávaná chyba\nMôže to byť problém s internetovým pripojením? Prosím skúste znovu to o niečo neskôr.",
  "ERROR_RATE_LIMIT": "Neočakávaná chyba\nMomentálne prijímame príliš veľa žiadostí platbu. Pred opakovaním platby počkajte niekoľko minút.",
  "ERROR_UNEXPECTED": "Neočakávaná chyba\nProsím skúste to o niečo neskôr, alebo kontaktujte našu podporu so správou: {{message}}",
  "ERROR_PUBLIC_KEY_IS_NOT_TEST": "Platobné okno je v testovacom móde, ale použitý verejný kľúč patrí k produkčnému účtu. Prosím použite verejný kľúč patriaci k testovaciemu účtu.",
  "ERROR_PUBLIC_KEY_IS_TEST": "Platobné okno je v produkčnom móde, ale použitý verejný kľúč patrí k testovaciemu účtu. Prosím použite verejný kľúč patriaci k produkčnému účtu.",
  "ERROR_PUBLIC_KEY_UNKNOWN": "Zadaný verejný kľúč nepatrí k Paylike účtu. Zadajte správny verejný kľúč a skúste znova.",
  "ERROR_PUBLIC_KEY_PAYMENTS_NOT_ALLOWED": "Platby s verejným kľúčom nie su povolené.",
