...
const Map<String, String> en = {
  ...
  "ERROR_TIMEOUT": "Unexpected issue\nCould there be an issue with your internet connection? Please try again a little later.",
  "ERROR_RATE_LIMIT": "Unexpected issue\nWe are currently receiving too many payment requests. Please wait a few minutes before trying again.",
  "ERROR_UNEXPECTED": "Unexpected problem\nPlease try again a little later or contact our support with the message: {{message}}.",
  "ERROR_PUBLIC_KEY_IS_NOT_TEST": "The payment popup is in test mode, but the public key provided is for a live account. Please use a public key for a test account.",
  "ERROR_PUBLIC_KEY_IS_TEST": "The payment popup is in live mode, but the public key provided is for a test account. Please use a public key for a live account.",
  "ERROR_PUBLIC_KEY_UNKNOWN": "The provided public key is not associated with a Paylike account. Update the public key and try again.",
  "ERROR_PUBLIC_KEY_PAYMENTS_NOT_ALLOWED": "The public key is not allowed to accept payments.",
